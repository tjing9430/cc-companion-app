...
- [DasterProkio/awesome-ai-companion](https://github.com/DasterProkio/awesome-ai-companion) — features this project.

## Trademark Disclaimer

This project is not affiliated with Anthropic. "Claude" and "Claude Code" are trademarks of Anthropic PBC. This project ships no model service of its own; all LLM calls use your own API key or subscription.
