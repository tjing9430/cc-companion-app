...
const ALWAYS_FRESH = ['/app.js', '/js/util.js', '/js/markdown.js', '/js/state.js', '/js/console-view.js', '/js/settings-view.js', '/js/memory-view.js', '/js/chat-view.js', '/styles.css', '/index.html'];
const STATIC_ASSETS = [
  '/',
  '/index.html',
  '/styles.css',
